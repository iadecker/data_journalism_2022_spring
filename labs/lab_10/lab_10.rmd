...
```
**A2.** As opposed to a bar chart, this is a scatterplot. The scatterplot allows us to see the correlation between various variables (undisbursed loans and total barber loans) than we'd be able to see in a bar chart. I decided to use a scatterplot because it allows us to 
