...
**A3.** The map we get shows that the counties that have less than 50% of people fully vaccinated are primarily on the Eastern Shore and in the Northwestern part of the state. With the exception of some areas in Baltimore, PG and Anne Arundel County, the suburbs of DC and counties that generally are more liberal tend to have higher vaccination rates than areas farther away from the nation's capital and that are predominantly right-leaning. Another thing to note is that the areas with lower vaccination rates also tend to be more rural than those with higher rates, which are urban. That said, there are some counties Frederick and Carroll that are farther out from DC but still have vaccination rates above 50%. In sum, the farther away from the cities you get, the lower the fully vaccinated population gets. This is not true across the board, but it can tell us general trends about certain areas.