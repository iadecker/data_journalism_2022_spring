...
description <- paste("The most recent crime incidents on WVU's campus on ", format(wvu_incidente$title, format="%B %d"), " ", direction, " was ", changetext, " total incidents of this crime", sep="")
