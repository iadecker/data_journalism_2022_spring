...
description <- paste("The most recent crime incidents on WVU's campus on ", format(latest_date$date, format="%B %d"), " was", latest_date$total direction, " was total incidents of this crime ", total_incidents, sep="")
```
...
Question: Is there a spike in certain crimes on holidays? Thinking about a holiday like Halloween, what are the msot common crimes that happen? Are carjackings popular? Do buglaries go up? Homicides? Assaults?
