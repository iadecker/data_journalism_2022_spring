...
**A2.** The spatial pattern I see is that a vast majority of the mines with permits that are set to expire after Sept. 1, 2021. are found in the southern-central part of the state. Moreover, there are virtually no expiring permits in the western part of the state. Compared to the first map, this map's spacial pattern shows that the southern-central part of the state is in serious trouble in the coming years. West Virginia is heavily dependent on mining, so the fact that a majority of its mine permits are set to expire will negatively impact the job market and the state's GDP.
