...
**A1** Region: Suburban Washington Region. County: Montgomery County
...
**A2** The data we produced in A1 shows which region and county/city accounted for the largest percentage of international migration for the time period of July 2011-July 2019. We were able to see this in the datat becasue we added a "Total" column which showed us which region/city/county had the largest % of int'l migration for July '11-'19.
...
**A3** Region: Southern Maryland Region. County: Calvert County
...
**A4** According to census.gov, Calvert County, which saw the largest decrease in international migration, is 81% white. With an overwhelming majority of the county white, it is possible that the few people were looking to move to the area due to its homogeneous makeup.

https://www.census.gov/quickfacts/calvertcountymaryland
...
```{r}
# Write the code to load the CSV file here
domestic_migration <-read_csv("domestic_migration.csv", skip=2, col_names=c("State_Jurisdiction", "July_2011", "July_2012", "July_2013", "July_2014", "July_2015", "July_2016", "July_2017", "July_2018", "July_2019", "Total"))
```
...
**A5** The Maryland individual jurisdiction that saw the largest net decrease in domestic migration overall was Baltimore City, with a decrease of 62834 people.
...
**A6** There were 14 regions & jurisdictions that had net positive migration for July 2017, July 2018 and July 2019.
...
**A7** This data shows us which regions & jurisdictions had net positive migration for July 2017, July 2018 and July 2019.

I find it interesting that Frederick County had the highest total (11310) of domestic migration. Frederick is a pretty rural area, so it's interesting that the greatest amount of people went there.
