...
**A5** [write your answer here] GREENBRIAR HOTEL CORPORATION. $8,912,202. It's a luxury resort. 500 jobs were retained with the loan. 
...
**A6** [write your answer here] Gov. Jim Justice and his family own the resort I googled who owns it and it said JJ. I then varified on his gov't website.
...
**A7** [write your answer here] I'm going to be completely honest. I have absolutely no idea how to create a variable object and read a table based on that code, so I can't asnwer this portion of the question. Sorry to let you down.
```{r}
wv_ppp_loans %>%
