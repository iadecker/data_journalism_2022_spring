...
A2: 25301 is the zip code that had the highest total amount of loans ($160721320.88). The name of the business that got the largest loan (by dollar value) in this zip code was THE EYE AND EAR CLINIC OF CHARLESTON DBA CHARLESTON SURGICA (1520007.00). 
...
west_virginia_rep <-west_virginia_ppp %>%
  filter(
