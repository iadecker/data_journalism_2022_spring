...
**Answer** We see a shapefile with various files within.
...
**Answer** This dataset gives us general information about every hospital (7,581) in the United States. The columns provide information about each individual hospital, including size, location and type.
...
**Answer** This bit of code is us telling R to provide hospitals from dataset but this time only give us those in Maryland (MD). From this, we learn that there  are 72 hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code shows us the seven different types of hospitals in Maryland. They are: GENERAL ACUTE CARE, PSYCHIATRIC, MILITARY, CHRONIC DISEASE, LONG TERM CARE, REHABILITATION and SPECIAL.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The code block below is us asking R to provide just the hospitals that fall under the "GENERAL ACUTE CARE" category in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We get a simple ggplot, but all we see are dots that sort of resemble the state of Maryland. The dots represent the 50 GENERAL ACUTE CARE hospitals and where they are geographically located in the state. But if you didn't know the exact shape of the state, you would be excused for not knowing what this jumble of dots was.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code block is us installing the package "tigris."
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We get a dataframe with information from all the counties in the U.S.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We are filtering for just Maryland counties using the state's code: 24.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We see a ggplot of Maryland on a longitudinal-latitudinal, but interestingly enough, it has included the Chesapeake as part of the land of the state.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This shows the same state map but with the 50 GENERAL ACUTE CARE hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** In this code block, we are getting a sense of which hospitals have the most beds. We are using color to show which ones have more. This shows us where in the state the largest hospitals are.
...
**Answer** We are loading three libraries - sf, janitor, tidycensus - to help with our coding work. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is the same data frame of the 50 GENERAL ACUTE CARE hospitals in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This shows us how many hospital beds each MD county has. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This shows us the populations of each MD county. We can access this info through tidycensus using the population code B01001_001.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code is us pulling geometry info from tidycensus while also pulling in population data.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is just so we can see the two separate datasets md_county_population and md_beds_by_county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Woah, Nelly, we're doing a lot here. In this code block we are changing md_county_population so that we can join it with md_beds_by_county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is us joining md_county_population and md_beds_by_county together into a new dataset called md_beds_per_100k.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is us making the N/As in Queen Anne's County and Carolina County values of 0.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is us calculating the number of beds per 100,000 for each MD county (mutate(beds_per_100k = total_beds/population*100000)). We also want to see it from largest to smallest (arrange(desc(beds_per_100k)))
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This gives us a choropleth map showing which MD counties have the higest number of hospital beds per 100,000 people.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This changes the color scheme of the choropleth map to "magma" so that we can better visualize which MD counties have the higest number of hospital beds per 100,000 people.
...
**Answer** This is the best choropleth map to date. This one gives us a clear picture of the fine-grained differences between MD counties, something the other maps did not do as well.
