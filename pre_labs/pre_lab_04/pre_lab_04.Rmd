...
**Answer** Yes, they have the same column structure (9).
...
**Answer** The error message has to do with the fact that we have two different categories — <character> and <double> — which makes it impossible for the code to combine the two field becasue they are not identical.
...
**Answer** No, every row does not have demographic data. There are a bunch of NA fields near the end of the dataset.
...
**Answer** I might be reading this wrong, but I still see rows with NA.
...
**Answer** 41968 loans went to ZCTAs with more than 50% non-Hispanic Black population. Avg. amnt: 55546.84. Med. amnt: 19949.
...
**Answer** Loans: 112056. Avg: 89194.67	. Median: 20833
...
**Answer** 
Rural Total, Avg, Med: 145, 44815.22, 19064.57
Urban Total, Avg, Med: 41823, 55584.05, 19950.00
...
**Answer** 
Rural Total, Avg, Med: 18083, 74463.32, 20833
Urban Total, Avg, Med: 93973, 92029.39, 20833
