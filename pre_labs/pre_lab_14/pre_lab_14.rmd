...
**Answer** It gives us just one eaxmple of each unique thing. This helps us analyze each unique word.
...
**Task** Run the following code and describe the results.
**Answer** It gives us a dataframe with the top 10 bigrams - two words found back-to-back - from our list of tweets in 2020.
...
**Task** Run the following code and describe the results.
**Answer** We get two dataframes showing us the top 10 bigrams for Democrats and Republicans. There are more tweets on the Democratic side
