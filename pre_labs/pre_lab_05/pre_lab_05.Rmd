...
**Answer** One problem that is preventing proper grouping is that the results don't match in terms of title case. 
...
**Answer** Refinr changed most of the city_clean objects to be title case. It also fixed some of the spelling errors.
...
**Answer** Title case, spelling, capitalization
...
**Answer** I might be misreading the data, but they look pretty similar. Both lines of code helped fixed the mess of title case, but there still do appear to be some cities that are all uppercase.
