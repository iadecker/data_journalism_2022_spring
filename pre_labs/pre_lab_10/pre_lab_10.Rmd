...
**Answer** https://datawrapper.dwcdn.net/1Ll2y/1/
...
**Answer** This code block is shows us how many PPP loans each MD county received.
...
**Answer** This code block shows us a cleaned version of the previously created dataframe, but this time, we have removed the extraneous records. 
...
**Answer** The contents of the new `fips_code` (five digits) column are the combinations of the state (two digits) and county (three digits) codes.
...
**Answer** What we see in `md_counties_with_fips` is a dataframe that has combined the information from md_counties and md_fips.
...
**Answer** This map shows us only Maryland counties as opposed to each county in the USA.
...
**Answer** The changes from the previous map include commas in the numbers of loans per county; the dollar amount of the loans and proper capitalization of the counties.
...
**Answer** https://datawrapper.dwcdn.net/nqWvp/1/
