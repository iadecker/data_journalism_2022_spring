...
**Answer** We see a dataframe with vaccination data, from first dose per day to second dose per county.
...
**Answer** Yes, not every county has the same number of rows, which means some counties have more data than others.
...
**Answer** These data points could have been collected incorrectly. For example, maybe someone forgot to notate the county, for we are missing quite a few.
...
**Answer** For the most part, less people are getting fully vaccinated each day.
...
**Answer** The trend is that fewer people are getting vaccinated each day after an initital surge in April 2021.
...
**Answer** This is the description we are given: "The number of people in Prince George's County who got fully vaccinated on March 06 decreased by -73.77 percent compared to the week before"
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer** What is this question even asking us?
...
**Answer** The chart shows a steady spike in covid cases, with a sharp increase in early 2022.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** The chart also shows a continual increase in covid cases.
...
**Answer** There are 3,233 rows in the counties dataframe.
...
**Answer** This map shows us where the highest amount of covid cases are by MD county.
