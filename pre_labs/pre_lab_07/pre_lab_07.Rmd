...
**Answer** There is a table with the NAICS codes based on number (sector) and what their corresponding sectors are.
...
**Answer** The page source function lets us see the code for exactly what info we want.
...
**Answer** We get a head and a body from an html document. 
...
**Answer** We get something that says "html" and that has a head, body and xml attributes below it.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** We see the code details of the portion of the page we have used the inspect element function for.
...
**Answer** We get six different tables. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** I see the following: [[1]], [[2]], [[3]], [[4]], [[5]], [[6]] with a bunch of other information in the following rows.
...
**Answer** I see that within each dataframe, there is additional information.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** I see a table with two columns and various rows.
...
**Answer** We get just sector and description after running this code.
...
**Answer** It cut off the final row.
...
**Answer** We get a tibble with sector and description.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** I see various tables that are in the webpage.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** It's a funky looking thing thing with a head and body and lots of asterisks. 
...
**Answer** We get an html_node with four elements and a lot of funky text.
...
**Answer** We get an unformatted 6x6 dataframe.
...
**Answer** Now we have a 1x2 tibble that is easier to navigate.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The webpage provides info about mining, which has a NAICS code of 21.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This is for the NAICS code 23.
...
**Answer** We get the industries with [1] in front.
```{r}
...
**Answer** I see that a list called "list_of_sectors" has been created.
```{r}
...
**Answer** It's a shorter list of industries. 
```{r}
...
**Answer** I'm getting an error message :-(.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** We get a concise list of industries.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** We get another error message.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** We see [1] followed by the numbers 1-10.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** 20 x 2 tibble with sector and description.
...
**Answer** We see a 1 by 2 tibble with data_series and nov_2021 as the columns.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** Sector/Description 20x2 tibble.
```{r}
# Define url of page we want to scrape
...
**Answer** It added a third column called "sector_url."
...
**Answer** It added a fourth column called "sector_xpath_id."
...
**Answer** It eliminated one of the rows.
...
**Answer** We get a bunch of dataframes.
...
**Answer** Again, we get a lot of dataframes.
...
**Answer** We get a bunch of 1x6 dataframes.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** We get cleaned up dataframes.
...
**Answer** We get a single, 19x3 dataframe with all the info.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Info on mining, quarrying and oil — NAICS 21.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** I see a similar webpage with less data for NAICS 11.
...
**Answer** It cuts our dataframe down to 19x3, eliminating agriculture. 
