...
**Answer** We see that the ppe_amount_per_employee by pct_trump is .22 on the -1 to 1 scale, which shows some correlation but not a lot. In the businesses_receiving_ppe_pct by pct_trump, we see the correlation coefficient is .52, showing a bit more correlation. In other words, the correlation coefficient here is shwoing us numerically what the graph showed us visually.
```{r}
reveal_data %>%
