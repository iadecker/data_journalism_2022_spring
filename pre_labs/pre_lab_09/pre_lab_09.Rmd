...
**Answer** The code below shows us the 10 MD counties that received the most PPP loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** We see a graph that represents the Project_county_loan by the total count.
...
**Answer** The new graph is ordered from lowest county to highest.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The new chart swapped the x- and y-axis and made the county names more legible.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The new chart has a white background as opposed to a gray one.
...
**Answer** This chart has a new theme — economist. Economist maked the background a gray-blue color.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** We now have a title, a source, and both thhe x- and y-axis have been cleaned up with easier-to-read titles.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The code below shows us PPP loans sorted by the date they were approved.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** We see a wonky chart that shows the spikes in PPP applications.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** We see the same wonky chart, but this time it shows the spikes in PPP applications by individual months, although they are overlapping.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** We now have a cleaned x-axis. The code  changed the angle of each month to 45 degrees so that each month would neatly fit on the x-axis.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
