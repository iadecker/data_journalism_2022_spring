...
**Answer** The code below shows us the top 10 MD counties that received the most PPP loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** We see a graph that shows the Project_county_loan by the total count.
