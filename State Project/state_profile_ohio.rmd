...
**A1.** Ohio had 352,010 PPP loan applications. I started by creating a separate dataframe that was a bit cleaner. That dataframe had standardized, five-digit zip codes and city and address names. With that dataframe, I started doing my analysis.I then started looking at specific categories. I started on a larger scale looking at Ohio cities. This wasn't a particularly interesting finding because the top three were predictably Columbus, Cleveland and Cincinnati. I then wanted to go deeper and look at counties. I ran into a similar issue with the cities dataframe; the top counties had the largest cities in them. The counties were CUYAHOGA (Cleveland), FRANKLIN (Columbus) and HAMILTON (Cincy). Where things did get a little interesting was when we added an average PPP amount column. When we did that, HOLMES (111924.81) and TUSCARAWAS (105982.16) jumped to the front. Holmes was 61 of 88 counties in total loans and Tuscarawas was 32. The population of Holmes is about 44,000 and Tuscarawas is 92,000. The two largest industries in Tuscarawas are Manufacturing and Health Care & Social Assistance, according to https://datausa.io/profile/geo/tuscarawas-county-oh. Both are industries that were impacted by the pandemic, so it's possible these industries applied for and got large loans. Holmes' top two industries were Manufacturing and Retail Trade. The explanation here in PPP loans is similar to that of Tuscarawas County. Another interesting data point to note is that the industry with the most loans was beauty salons (16,955). With people not going in to get beauty work, it makes sense why this industry would be applying for PPP loans. While a vast majority of the businesses in the state were non-franchise operations, there were some chains that received loans. Of the franchise businesses, Subway locations got 396 loans. McDonald's got 172 and General Motors got 85. The last bit I wanted to look at was towns where undergraduate institutions were located. For this, I picked Licking County (Denison University) and Lorain County (Oberlin College). I then looked at the the individual towns - Granville for Denison and Lorain for Oberlin. Interestingly, neither college had a single PPP loan, according to the data. With colleges losing large amount of money because of the pandemic, nobody was paying room and board, I imagined they would be applying for PPP loans. One potential explanation for this is that both colleges have endowments over 900 million dollars, so maybe they used that to help during the pandemic. 
...
**A3.** 
Because my dataframe did not have any undisbursed amounts, I used min and max values to get the data. After creating the dataframe, we see that there seem to be several outliers, primarily the lender Harvest Small Business Finance, LLC. This lender gave out 6672 loans for a total of $138,997,776. On our graph, it is the top dot represented. The graph tells us several interesting bits of information. First, it confirms that the most people applied for the max amount. For sole proprietors or independent contractors with no employees, the maximum possible PPP loan is 20,833 dollars. When we look at our chart, a majority of the loans are either that amount or close to it. Another thing to point out is that most of the rest of the applications fall on the right side of the graph, which means that there were more lenders who gave smaller amounts than larger amounts. One potential explanation for this could be that those lenders started loaning later in the program. I know that we had spoken about how to do that, but I don't know how to write that code. We also see that the highest loan was 50,000 dollars. This is well below the maximum of 10 million that businesses were limited to. It's also interesting to look at the seven largest lenders. There were seven lenders that gave hundreds of thousands of loans worth the max (20833) over the course of this project.
...
#I'm sorry that I didn't generate a choropleth map and the csv never saved out. I have never felt more outside my comfort zone in a class or project. I wouldn't have completed a single step of this project without the help of others. The amount of hand-holding I have needed throughout this class is embarrassing. I'm sorry I couldn't be a better student for you. You are an excellent teacher who has been unbelievably supportinve this semester. Again, I truly apologize that I couldn't give you a better final project. Have a wonderful summer!
```
...
**A5.** I also looked at the total loans and total amounts specific addresses received. This address - 4503 Marburg Ave - received 57 loans for $3,899,100.10. The business at this address is a Planet Fitness that, according to google, is temporarily closed. It's possible that this one gyme applied for over 3 million dollars in loans, but 57 separate applications is still a lot of loans. Thsi address is in a shopping area, so it's possible that there were other businesses that used this address.
