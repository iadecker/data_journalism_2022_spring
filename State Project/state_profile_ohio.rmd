...
If it was just one address, then I would start asking questions. It would be useful to talk to a manager or owner (if they would give you time), but former employees would also be good. It's possible that the company fired people even though it was getting loans. Talking to people who were impacted would be a great place to start. 
